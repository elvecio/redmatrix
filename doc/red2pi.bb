...
[code]pi@pi /var $ sudo git clone https://github.com/beardyunixer/redmatrix.git www[/code]

Download the sources of the addons from GIT
[code]pi@pi /var/www $ sudo git clone https://github.com/beardyunixer/redmatrix-addons.git addon[/code]
